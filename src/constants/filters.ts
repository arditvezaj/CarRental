...
export const carModels: CarModelProps = {
  ...
  Audi: ["All", "A3", "A4", "Q5", "Q7", "TT", "A5", "A6", "Q3", "A7", "A8"],
  Tesla: [
    "All",
    "Model S",
    "Model 3",
  ...
  Jaguar: ["All", "XF", "XJ", "F-Type", "E-Pace", "F-Pace", "XE", "I-Pace"],
  "Land Rover": [
    "Range Rover",
    "Defender",
    "Discovery",
  ...
  Lexus: ["All", "RX", "ES", "NX", "GX", "LS", "UX", "LX", "IS", "RC"],
  Ferrari: [
    "All",
    "488",
    "Roma",
  ...
  Peugeot: ["All", "208", "308", "508", "3008", "5008", "2008", "4008"],
  Renault: [
    "All",
    "Clio",
    "Megane",
  ...
  Chrysler: ["All", "300", "Pacifica", "Voyager", "Aspen", "Sebring"],
  Dodge: [
    "All",
    "Charger",
    "Challenger",
  ...
  Ram: ["All", "1500", "2500", "3500", "ProMaster", "ProMaster City"],
  Acura: ["All", "MDX", "RDX", "TLX", "ILX", "NSX", "RLX"],
  Infiniti: ["All", "Q50", "Q60", "QX50", "QX60", "QX80", "QX30", "Q70"],
  Suzuki: [
    "All",
    "Swift",
    "Vitara",
  ...
  Volvo: ["All", "XC40", "XC60", "XC90", "S60", "S90", "V60", "V90"],
  Saab: ["All", "9-3", "9-5", "900", "9000", "9-4X", "9-7X"],
  Bentley: [
    "All",
    "Continental",
    "Flying Spur",
  ...
  Genesis: ["All", "G70", "G80", "G90", "GV70", "GV80"],
  McLaren: ["All", "720S", "Artura", "GT", "Senna", "P1"],
  Dacia: [
    "All",
    "Duster",
    "Sandero",
